...
On Kubernetes, run it as a Deployment with the config mounted from a ConfigMap
and AWS access granted through IRSA:
...
be granted through an IAM user, an instance role, or IRSA on EKS.
