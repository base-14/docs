---
title: Java OpenTelemetry Custom Instrumentation - Spans & Metrics Guide
sidebar_label: Java
sidebar_position: 3
description:
  Add custom OpenTelemetry spans, metrics, and traces to any Java app.
  Manual instrumentation for business logic beyond
