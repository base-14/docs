...
ENV OTEL_RESOURCE_ATTRIBUTES=environment=demo
...
services:
  app:
    ...
    environment:
      ...
      OTEL_EXPORTER_OTLP_ENDPOINT: http://scout-collector:4318
      OTEL_RESOURCE_ATTRIBUTES: environment=dev,service.version=1.0.0
      OTEL_TRACES_EXPORTER: otlp
      OTEL_METRICS_EXPORTER: otlp
      OTEL_LOGS_EXPORTER: otlp
    depends_on:
...
otel.resource.attributes=service.namespace=my-namespace,environment=development
