...
<head>
  <script type="application/ld+json">
    {JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What are the key roles in an incident war room?","acceptedAnswer":{"@type":"Answer","text":"The four core roles are Incident Manager (leads response and makes decisions), Scribe (documents events and timeline in real time), Communications Person (manages internal and external updates), and Actors (technical engineers performing investigation and remediation)."}},{"@type":"Question","name":"How do you run an effective incident war room?","acceptedAnswer":{"@type":"Answer","text":"Start with one consistent link for all war rooms that everyone in the org already has. Assign four clear roles immediately: Incident Manager, Scribe, Communications Lead, and Technical Actors. Enforce pairing on all changes and document every decision in real time."}},{"@type":"Question","name":"What is a blameless postmortem and why does it matter?","acceptedAnswer":{"@type":"Answer","text":"A blameless postmortem is a post-incident review focused on systems and processes, not individual mistakes. It documents root causes, timelines, and action items so the organization learns from each incident and can target systemic fixes rather than blame."}},{"@type":"Question","name":"What is the first thing you should do when a production incident is declared?","acceptedAnswer":{"@type":"Answer","text":"Open a pre-configured war room using a single, consistent link that everyone in the organization already has. Assign Incident Manager, Scribe, and Communications roles immediately, and trigger automated notifications to alert the relevant on-call teams."}},{"@type":"Question","name":"How do you reduce MTTR during a production incident?","acceptedAnswer":{"@type":"Answer","text":"Three things have the biggest impact: assign an Incident Manager quickly, keep communication in a single structured channel instead of scattered Slack threads, and pair engineers on all changes to catch errors under pressure."}}]})}
  </script>
</head>
