...
<head>
  <script type="application/ld+json">
    {JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is Scout MCP and how does it work?","acceptedAnswer":{"@type":"Answer","text":"Scout MCP is base14's implementation of the Model Context Protocol, allowing AI coding agents like Claude Code, Claude Desktop, and Gemini CLI to query observability data in natural language. It exposes 10 read-only tools covering traces, logs, metrics, service topology, and alerts - so you can ask 'why is checkout slow?' and get answers from real telemetry."}},{"@type":"Question","name":"Can I query observability data from Claude Code or Gemini CLI?","acceptedAnswer":{"@type":"Answer","text":"Yes, if your observability platform supports the Model Context Protocol (MCP). Scout exposes an MCP endpoint with 10 read-only tools. Claude Code connects with a single command, while Claude Desktop and Gemini CLI require a config file edit."}},{"@type":"Question","name":"Can Scout MCP modify or delete observability data?","acceptedAnswer":{"@type":"Answer","text":"No. All 10 MCP tools are read-only and idempotent. The AI agent cannot create, modify, or delete anything in your environment, making the integration safe for everyday use."}},{"@type":"Question","name":"How do you use AI to debug production issues?","acceptedAnswer":{"@type":"Answer","text":"With an MCP-enabled observability platform, you describe the problem in plain English and the AI agent chains the right queries automatically. For example, asking 'the checkout page is slow' triggers the agent to list services, query traces filtered by high duration, fetch span details, and identify the bottleneck - without you writing a single query."}},{"@type":"Question","name":"What is the Model Context Protocol (MCP) for observability?","acceptedAnswer":{"@type":"Answer","text":"MCP is a standard that lets AI coding agents call external tools. For observability, this means an AI assistant can query traces, logs, metrics, service topology, and alerts programmatically. The agent discovers available data schemas automatically, so you don't need to know exact attribute names to ask questions."}}]})}
  </script>
</head>
